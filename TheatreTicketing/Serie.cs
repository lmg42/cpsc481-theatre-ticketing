        ...
        public void Populate(int i)
        {
            switch (i)
            {
                ...
                case 1:
                    ...
                    concerts = new Concert[] { NextConcert(), 
                        new Concert("The Hyphenated Liszt ", "October 28, 2011", "8pm - 11pm", "The Hyphenated Liszt is the third in a programme of six featuring the celebrated works of Franz Liszt and will include Schubert and Chopin Transcriptions, A Night at the Opera and the extraordinary Danse Macabre."),
                        new Concert("Schubert's Winterreise ", "November 19, 2011", "8pm - 11pm", "Tenor soloist Timothy Shantz is joined by pianist Marilyn Engle and performs the Winterreise song cycle. The 24 poems of Wilhelm Müller, set for voice and piano by Franz Schubert, are described as epic in sadness, the blending of two moods of beauty - in verse and in music - overshadowed by death."), 
                        new Concert("The Literary Liszt ", "January 14, 20121", "8pm - 11pm", "Programme four of six, featuring more works by the legendary Franz Liszt, focuses on the cycle of piano pieces entitled Harmonies poétiques et religieuses. Concerts five and six of Liszt’s works will be performed next season. "), 
                        new Concert("Old vs New ", "March 24, 2012", "8pm - 11pm", "Ensemble Made in Canada is one of Canada’s premier piano quartets and performs on a collection of rare Italian instruments. Their program will feature traditional piano quartets, including the Schumann piano quartet, and a new commission by Canadian composer and scholar John Burge.") };
                    break;
                case 2:
                    seriesName = SeriesName.Discovery;
                    concerts = new Concert[] { new Concert("Contemporary Canada ", "November 5, 2011", "8pm - 11pm", "Japanese/Canadian pianist Yoko Hirota will perform a concert of music by contemporary Canadian composers. Her performance will include pieces by Gary Kulesha, Francois Morel and our very own Laurie Radford. Praised as one of the leading interpreters of contemporary piano repertory of her generation, Yoko’s performance vows to be \"concise and keenly projective.\""), 
